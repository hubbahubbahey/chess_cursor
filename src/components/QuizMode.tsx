...
export default function QuizMode() {
  ...
  }, [currentOpening, quizPositions.length])
              ...
              <>
                ...
                {showHint && (
                  <div className="bg-accent-gold/20 text-accent-gold px-4 py-2 rounded-lg mb-4 flex items-center gap-2">
                    <Lightbulb size={18} />
                    <span>
                      Hint: The move starts with <span className="font-mono font-bold">{correctMove[0]}</span>
                    </span>
                  </div>
                )}
              </>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      The correct move was <span className="font-mono text-accent-gold">{correctMove}</span>
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-4 bg-surface-800 rounded-xl p-4">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-white font-medium">
                {quizScore} / {questionsAnswered} ({Math.round((quizScore / questionsAnswered) * 100)}%)
              </span>
            </div>
